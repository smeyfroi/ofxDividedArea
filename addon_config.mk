...
meta:
	ADDON_NAME = ofxDividedArea
	ADDON_DESCRIPTION = An area divided by non-intersecting lines
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon" "graphics"
	ADDON_URL = http://github.com/smeyfroi/ofxDividedArea

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	 ADDON_DEPENDENCIES = ofxGui ofxRenderer
